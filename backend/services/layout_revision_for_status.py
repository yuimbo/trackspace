...
from backend.embeddings.projection_config import FROZEN_SOURCES, REQUIRED_SOURCES
...
def layout_revision_for_projection(
    ...
    *,
    ...
    del proj
    eligible = eligible_paths_for_projection(
        infos, maps, FROZEN_SOURCES, REQUIRED_SOURCES
    )
